...
class SchedulerClient:
    ...
    async def remove_instance(self, instance_id: str) -> Dict[str, Any]:
        ...
        """
        return await self._request("POST", "/v1/instance/remove", json_data={"instance_id": instance_id})
    ...
    async def drain_instance(self, instance_id: str) -> Dict[str, Any]:
        ...
        """
        return await self._request("POST", "/v1/instance/drain", json_data={"instance_id": instance_id})
    ...
    async def get_drain_status(self, instance_id: str) -> Dict[str, Any]:
        ...
        Raises:
            SchedulerNotFoundError: If instance does not exist
        """
        return await self._request("GET", "/v1/instance/drain/status", params={"instance_id": instance_id})
    ...
    async def list_instances(self, model_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        return await self._request("GET", "/v1/instance/list", params=params)
    ...
    async def get_instance_info(self, instance_id: str) -> Dict[str, Any]:
        ...
        Raises:
            SchedulerNotFoundError: If instance does not exist
        """
        return await self._request("GET", "/v1/instance/info", params={"instance_id": instance_id})
    ...
    async def list_tasks(
        ...
        return await self._request("GET", "/v1/task/list", params=params)
    ...
    async def get_task_info(self, task_id: str) -> Dict[str, Any]:
        ...
        """
        return await self._request("GET", "/v1/task/info", params={"task_id": task_id})
    ...
    async def clear_tasks(self) -> Dict[str, Any]:
        ...
        """
        return await self._request("POST", "/v1/task/clear")
    ...
    async def get_strategy(self) -> Dict[str, Any]:
        ...
        """
        return await self._request("GET", "/v1/strategy/get")
    ...
    async def set_strategy(self, strategy_name: str, target_quantile: Optional[float] = None) -> Dict[str, Any]:
        ...
        return await self._request("POST", "/v1/strategy/set", json_data=json_data)
    ...
    async def subscribe_to_tasks(
        ...
        ws_url = urljoin(ws_url, "/v1/task/get_result")
