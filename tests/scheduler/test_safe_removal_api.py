...
class TestDrainStatusEndpoint:
    ...
    async def test_get_status_active_instance(self, client, register_test_instance):
        ...
        response = client.get(
            "/v1/instance/drain/status", params={"instance_id": "inst-1"}
        )
    ...
    async def test_get_status_nonexistent_instance(self, client):
        ...
        response = client.get(
            "/v1/instance/drain/status", params={"instance_id": "nonexistent"}
        )
...
class TestSafeRemoveEndpoint:
    ...
    async def test_remove_draining_instance_no_tasks(
        ...
        list_response = client.get("/v1/instance/list")
...
class TestTaskAssignmentWithDraining:
    ...
    async def test_no_available_instances_when_all_draining(
        ...
        # Drain both
        client.post("/v1/instance/drain", json={"instance_id": "inst-1"})
        client.post("/v1/instance/drain", json={"instance_id": "inst-2"})
...
class TestCompleteRemovalWorkflow:
    ...
    async def test_complete_workflow(self, client, register_test_instance):
        ...
        final_list = client.get("/v1/instance/list")
