...
class TestTaskScheduleInfoEndpoint:
    ...
    def test_schedule_info_single_task(self, test_client, task_registry, instance_registry):
    ...
    def test_schedule_info_multiple_tasks(self, test_client, task_registry, instance_registry):
    ...
    def test_schedule_info_filter_by_model_id(self, test_client, task_registry, instance_registry):
    ...
    def test_schedule_info_filter_by_instance_id(self, test_client, task_registry, instance_registry):
    ...
    def test_schedule_info_filter_by_status(self, test_client, task_registry, instance_registry):
        ...
        async def setup():
            ...
            task_running = await task_registry.create_task(
            ...
            task_completed = await task_registry.create_task(
    ...
    def test_schedule_info_filter_combined(self, test_client, task_registry, instance_registry):
        ...
        response = test_client.get("/task/schedule_info?model_id=model-a&status=completed")
        assert response.status_code == 200
    ...
    def test_schedule_info_response_fields(self, test_client, task_registry, instance_registry):
    ...
    def test_schedule_info_pagination(self, test_client, task_registry, instance_registry):
    ...
    def test_schedule_info_no_matching_filter(self, test_client, task_registry, instance_registry):
