...
from src.throughput_tracker import ThroughputTracker, InstanceThroughputData
...
class TestInstanceThroughputData:
    ...
    def test_add_execution_time(self):
        ...
        data = InstanceThroughputData(
            instance_endpoint="http://test:8001",
            window_size=3
        )
...
class TestThroughputTracker:
    ...
    @pytest.mark.asyncio
    async def test_get_averages_for_recent_instances_returns_only_new_data(self):
