"""Minimum Expected Time scheduling strategy.

This strategy selects the instance with minimum expected queue completion time,
considering both the current queue state and the predicted time for the new task.
"""
