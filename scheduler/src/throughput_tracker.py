...
class ThroughputTracker:
    ...
    def __init__(self, window_size: int = 20):
        ...
        self._instances_with_new_data: set = set()  # Track instances with data since last report
    ...
    async def get_averages_for_recent_instances_seconds(self) -> Dict[str, float]:
        """
