...
from src.pylet.deployment_executor import DeploymentExecutor, ExecutionResult
from src.pylet.instance_manager import (
    InstanceManager,
    ManagedInstance,
)
from src.pylet.migration_executor import MigrationExecutor, MigrationResult

if TYPE_CHECKING:
    from src.available_instance_store import AvailableInstanceStore
...
class PyLetDeploymentService:
    ...
    def sync_to_instance_store(
        ...
        from src.available_instance_store import AvailableInstance
