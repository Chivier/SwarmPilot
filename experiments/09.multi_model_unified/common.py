...
def calculate_makespan(completed_workflows: List[WorkflowCompletionEvent]) -> Dict:
    """
...
def print_continuous_mode_summary(strategy: str, makespan_metrics: Dict,
                                  a_metrics: Dict, b_metrics: Dict, wf_metrics: Dict):
    """
    Print a summary of metrics for continuous request mode.
