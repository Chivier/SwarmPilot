...
docker stop $(docker ps -a --filter "name=sleep_model_a" -q) && docker rm $(docker ps -a --filter "name=sleep_model_a" -q)
docker stop $(docker ps -a --filter "name=sleep_model_b" -q) && docker rm $(docker ps -a --filter "name=sleep_model_b" -q)
