...
Usage:
    ...
    uv run python examples/6.predictor_training/collect_and_train_qwen3vl.py --train

    # Collect only
    uv run python examples/6.predictor_training/collect_and_train_qwen3vl.py
